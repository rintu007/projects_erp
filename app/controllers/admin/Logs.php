...
class Logs extends MY_Controller
{
    ...
    function getLogs() {
        ...
        $this->datatables
            ->select("{$this->db->dbprefix(('logs'))}.log_id as id, {$this->db->dbprefix(('logs'))}.log_date, {$this->db->dbprefix(('logs'))}.log_act, {$this->db->dbprefix(('logs'))}.log_table, {$this->db->dbprefix(('logs'))}.log_ip, {$this->db->dbprefix(('logs'))}.log_user", FALSE)
            ->from("logs")
