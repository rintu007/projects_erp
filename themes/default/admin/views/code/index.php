                    ...
                    <ul class="dropdown-menu pull-right tasks-menus" role="menu" aria-labelledby="dLabel">
                        <li>
                            <a href="#" class="bpo" title="Edit Code"
                                data-content="<form><p>Please input new code</p><input type='text' name='code' id='code' style='width: 100px; margin-right:10px;' /><input type='button' value='Submit' class='btn btn-danger' onclick='submitss()'/> <a id='a__a' style='display:none' href='http://davelynstudio.com/app/admin/code/update' class='btn btn-danger'>submit</a></form>"
...
<script>
    function submitss(){
        ...
        a.setAttribute("href", "http://davelynstudio.com/app/admin/code/update?code="+document.getElementById("code").value);
        a.click();
    }
</script>
<?php if ($Owner || $GP['bulk_actions']) { ?>
